...
- Make full-sync AJAX prefetch more conservative with lower concurrency, jittered page delays, retry/backoff for soft-rate-limit symptoms, and visible fallback reasons.
- Document operation-outbox retry scheduling and local consistency audit as the next Rust-native data-engine candidates.
